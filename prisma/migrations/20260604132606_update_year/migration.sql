...
INSERT INTO "new_Metric" ("aprovechamiento", "createdAt", "id", "mes", "rechazo", "sede", "updatedAt", "year") SELECT "aprovechamiento", "createdAt", "id", "mes", "rechazo", "sede", "updatedAt", "year" FROM "Metric";
DROP TABLE "Metric";
